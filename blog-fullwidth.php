...
<body>
  ...
  <header>
                ...
                <div class="col-md-9 col-sm-12 col-12 col-lg-9">
                    <ul class="d-flex account_login-area">
                        ...
                        <li class="account-item">
                            ...
                            <h5><span>Company Location</span>2544 Kilindini Mombasa, Kenya</h5>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="breadcumb-area" style="background: url(./assets/images/breadcumb/bg-1.jpg) no-repeat center top / cover;
">
        <div class="container">
            <div class="row">
                <div class="col-12">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                    ...
                    <p>Subscribe to Our Newsletter to get the Latest News Feed</p>
                </div>
                <div class="col-lg-8">
